...
Engine unverändert (`proofboy/msheet/`, `proofboy/claimtypes/`, `proofboy/turing.py`); die Runde ändert Tooling, Sets, Tests und Wiki.
...
7. `tests/test_v13_harness.py`, `tooling/{harness,prompts,build_sets,evaluate}.py`, `proofboy/{turing,msheet,claimtypes}/` — Implementierung + Tests (744 Tests grün).
