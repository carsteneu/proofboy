...
- Zellen: 105 · valid 94 (0.8952) · axiomfrei 90 · sorry 0 · invalid 6 · timeout 0 · infra 0 · ohne Code 5 (davon Transportfehler 0)
...
| V-C | lemma | 9 | 7 | 8 | 0 | 5 | 8 | 0.4663 | 0.1944 | 15070 | 15432 |
...
| V-E | lemma | 9 | 7 | 8 | 0 | 2 | 9 | 0.4339 | 0.1587 | 6902 | 7434 |
...
| V-C | 21 | 17 | 18 | 0 | 6 | 0.4363 | 0.1403 | 28285 | 28928 | 145.6 |
| V-D | 21 | 21 | 20 | 0 | 0 | 0.517 | 0.1537 | 23116 | 23756 | 118.4 |
| V-E | 21 | 17 | 17 | 0 | 3 | 0.4492 | 0.1192 | 17181 | 18094 | 101.0 |

Hinweise: `valid` = elaboriert fehlerfrei (`leancheck`, Std-Minimalprojekt, Lean 4.33.1); `axiomfrei` = ohne Axiome (`propext`/`Quot.sound` zaehlen nicht als axiomfrei); `Fence` = Antwort enthielt einen Markdown-Code-Zaun; `RC-Lean`/`RC-Taktik` sind die heuristischen `leanfidelity`-Anteile der Denkspur (Untergrenze bzw. ueberschaetzend bei zitierten Code-Zeilen in Prosa — Augenschein-Stichprobe im Bericht); n klein, keine Signifikanz.