...
17. checks.py — Prüfer-Dispatcher. Branch `yesloop/proofboy-p7-halt` (= lokaler `master`, Merge 4fd2b30): `proofboy/checks.py` (accessed 2026-09-12)
18. turing.py — Turingmaschinen-Simulator. Ebd.: `proofboy/turing.py` (accessed 2026-09-12)
19. halt.py — `[HALT]`/`[SCORE]`-Claim-Typ. Ebd.: `proofboy/claimtypes/halt.py` (accessed 2026-09-12)
