...
derselben Zeile bleiben Behauptungen. `./...` am Ende eines Kommandos ist
ein Pfadmuster und kein Platzhalter; ein `<` ohne schliessendes `>` ebenso
wenig. Siehe README, Abschnitt "Grenzen", fuer die ausgemessenen
Grenzfaelle.
